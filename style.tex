...
%
\fancyhead[L]{}
\fancyhead[C]{\includegraphics[width=0.6cm]{images/epfl.png}\ \epfl\ - \school\ - \courseId\ \textbf{\courseTitle}\ \by\ \textit{\staff}\ - \academicSemester\ \academicYear}
%\fancyhead[RO,LE]{\slshape \leftmark}
\fancyhead[R]{}
\renewcommand{\headrulewidth}{0.4pt}
\renewcommand{\footrulewidth}{0.4pt}
\fancyfoot[L]{\author}% \slshape \rightmark}
\fancyfoot[C]{\thepage}
\fancyfoot[R]{Version \version\ \of\ \lastUpdate}
